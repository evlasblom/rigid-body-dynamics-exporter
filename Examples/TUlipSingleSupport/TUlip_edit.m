function Model = TUlip_edit(Model)
...
[trunkVertices,trunkFaces] = ...
    make_trunk(w1,w2,h1,h2,h3,th,[-th+(th-0.08) -(0.1519-w1)/2-w1 0]);
...
Base.visual.bodysizemin = -[off,fw/2,0];
Base.visual.bodysizemax = [fl-off,fw/2,0.05];
