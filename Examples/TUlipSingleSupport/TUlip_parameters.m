...
function [dout,rout,mout,iout] = TUlip_parameters()
...
% OUTPUT
% d was defined top down, but for left leg it is bottom up, 
% hence the minus sign for the left leg
dout = [-d.AnkleXFoot; % left leg
        -d.AnkleYAnkleX; 
        -d.KneeYAnkleY;
        -d.HipYKneeY;
        -d.HipXHipY;
        -d.HipZHipX;
        -d.TrunkHipZ + mirror_y(d.TrunkHipZ); % right leg
        mirror_y(d.HipZHipX);
        mirror_y(d.HipXHipY); 
...
rout = [mirror_y(r.AnkleYAxle)-d.AnkleYAnkleX; % left leg
        mirror_y(r.LowerLeg)-d.KneeYAnkleY;
        mirror_y(r.UpperLeg)-d.HipYKneeY;
        mirror_y(r.HipYAxle)-d.HipXHipY;
        mirror_y(r.HipXMotor)-d.HipZHipX;
        r.Trunk-d.TrunkHipZ;
...
iout = [inertiaAnkleYAxle; % left leg
        inertiaLowerLeg;
        inertiaUpperLeg;
        inertiaHipYAxle;
        inertiaHipXMotor;
