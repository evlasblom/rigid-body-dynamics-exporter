%R_MATRIX Calculates a rotation matrix of a kinematic chain.
%   H = R_MATRIX(model,q,from,to) provides the 
%   rotation matrix to express a point given in a body's 
...
function R = R_Matrix(model,q,from,to)
